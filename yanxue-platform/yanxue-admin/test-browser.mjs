...
(async () => {
  ...
  console.log('Navigating to http://localhost:13001...');
  await page.goto('http://localhost:13001', { waitUntil: 'networkidle', timeout: 30000 });
  ...
  if (errors.length > 0 || !appContent || appContent === 'APP ELEMENT NOT FOUND OR EMPTY') {
    process.exit(1);
  }
})();
